...
public abstract class AbstractBaseController {
    ...
    public ApiResponse<? extends RedisProduct<?>> getProductsOfMall(@PathVariable("domain") String domain, @PathVariable("mall_name") String mallName) {
        RedisProduct<?> product = redisService.getProductsFromRedisUsingKey(domain, mallName);
